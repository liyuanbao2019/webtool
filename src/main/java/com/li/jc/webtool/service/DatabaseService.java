...
import com.li.jc.webtool.dto.ExecuteSqlRequest;
import com.li.jc.webtool.dto.DataSourceDto;
import com.li.jc.webtool.dto.ResultEditCommitRequest;
...
public interface DatabaseService {
     ...
     * 新增数据源配置。
     */
    SqlResultResponse addDataSource(com.li.jc.webtool.config.DatabaseConfig.DataSourceConfig request);

    /**
     * 更新数据源配置。
     */
    SqlResultResponse updateDataSource(int datasourceIndex, com.li.jc.webtool.config.DatabaseConfig.DataSourceConfig request);
