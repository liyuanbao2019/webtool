...
import com.li.jc.webtool.agent.AgentTerminalCallback;
import com.li.jc.webtool.agent.AgentTerminalClient;
import com.li.jc.webtool.agent.AgentTerminalSession;
import com.li.jc.webtool.config.ServerConfig;
import com.li.jc.webtool.dto.NodeDeployResult;
...
/** Executes one deployment node through direct SSH/SFTP or the terminal agent. */
@Slf4j
@Service
public class DeployExecutionService {
    ...
    public NodeDeployResult runOne(String serverId, ServerInfo server, String targetDir, String commands, boolean enableUpload,
