...
import com.gxcj.xjtool.config.AuthConfig;
import com.gxcj.xjtool.config.AuthInterceptor;
...
public class AuthController {
     ...
     */
    @Autowired
    private com.gxcj.xjtool.service.LoginAttemptService loginAttemptService;
    ...
    public void getCaptcha(javax.servlet.http.HttpServletResponse response, HttpSession session)
        ...
        String code = com.gxcj.xjtool.util.CaptchaUtil.generateCode(4);
        session.setAttribute("CAPTCHA_CODE", code);

        java.awt.image.BufferedImage image = com.gxcj.xjtool.util.CaptchaUtil.generateImage(code, 100, 38);
